...
zircon_component_frustum::zircon_component_frustum(void) :
	m_is_enabled{true}, m_component_type{kComponentTypezircon_component_frustum}
{
}
...
kotek::json::value zircon_component_frustum::serialize(void) noexcept
{
...
{
	*this = kotek::json::value_to<zircon_component_frustum>(data);
}
...
kotek::uint8_t zircon_component_frustum::get_component_type(void) const noexcept
{
