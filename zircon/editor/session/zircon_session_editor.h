...
// todo: probably you have to move session to separated project because by
// design we don't have to have a circular (recursive) dependency from linking
// and at the same time we shouldn't share projects without direct connections
...
private:
	...
	kotek::vector_t<kotek::core::ktkISDKUIElement*> m_imgui_ui_elements;
