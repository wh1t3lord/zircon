 ...
 */
enum class eZirconGameFeatures : Kotek::ktk::enum_base_t
{
	kFeature_Unknown = 0,
};
 ...
 */
enum class eZirconSDKFeatures : Kotek::ktk::enum_base_t
{
	kFeature_AddRequiredComponents_Automatically = 1 << 1,
	kFeature_SphereBoundingBox_Quality = 1 << 2,
