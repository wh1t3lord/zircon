...
> Last updated: 2026-09-22 (task Z25 A2: the editor CSG integration —
> the journaled primitive commands + the dirty/debounce rebuild
> scheduler + the one-draw-call dynamic pool + the editor_csg pass;
> see the Z25 row).
