...
> Last updated: 2026-09-22 (task Z25 A3: the game bake — the
> world-grid chunking + the u16/u8 quantization + the .kpack payload
> through the shared encoder + the pack-loaded B1 chunk-pool read
> path; the CSG ARC IS COMPLETE, see the Z25 row).
