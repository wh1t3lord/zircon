...
> Last updated: 2026-09-23 (task Z24 B3a: the nanite-path content side — the
> meshlet clusterizer + the decimation-free LOD hierarchy + the pack format;
> see the Z24 row).
