...
> Last updated: 2026-09-12 (Z23: the fault-tolerant resource defaults chain —
> filesystem plan B4, the FINAL phase; embedded defaults landed in zircon.core,
> see the Z23 row).
