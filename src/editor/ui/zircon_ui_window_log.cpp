...
zircon_editor_ui_state_window_log::zircon_editor_ui_state_window_log() : m_is_show_window(false)
{
}
...
int zircon_editor_ui_state_window_log::Get_ID(void) const
{
	return static_cast<int>(eZirconWindowIDs::kWindow_SDK_Log);
}

void zircon_editor_ui_state_window_log::Show(void)
{
	this->m_is_show_window = true;
}

void zircon_editor_ui_state_window_log::Hide(void)
{
	this->m_is_show_window = false;
}

bool zircon_editor_ui_state_window_log::Is_Shown(void) const
{
