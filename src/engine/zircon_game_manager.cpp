...
// bgfx
	...
	// the generated pass factory (regenerated by the PRE_BUILD step of
	// zircon.render.passes.bgfx) — includes every concrete pass header it
	// can instantiate, so this one header covers both sessions
