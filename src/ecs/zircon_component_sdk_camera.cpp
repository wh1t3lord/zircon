...
const zircon_component_camera&
zircon_component_sdk_camera::get_camera(void) const noexcept
{
	return this->m_camera;
}

zircon_component_camera&
zircon_component_sdk_camera::get_camera(void) noexcept
{
	return this->m_camera;
}
...
kotek::json::value zircon_component_sdk_camera::serialize(void
) noexcept
{
...
{
	*this =
		kotek::json::value_to<zircon_component_sdk_camera>(data
	    );
}
...
kotek::uint8_t
zircon_component_sdk_camera::get_component_type(void
) const noexcept
{
...
bool zircon_component_sdk_camera::is_enabled(void
) const noexcept
{
	return this->m_is_enabled;
}

void zircon_component_sdk_camera::set_enabled(bool status
) noexcept
{
