	...
	kotek::json::value& write_to, const zircon_component_ui_camera& data)
{
	...
	ui_camera[ZIRCON_DEF_GAME_ZIRCON_COMPONENT_UI_CAMERA_FIELD_M_IS_ENABLED] =
		data.is_enabled();

	#ifdef KOTEK_DEBUG
	ui_camera[ZIRCON_DEF_GAME_ZIRCON_COMPONENT_UI_CAMERA_FIELD_M_COMPONENT_TYPE] =
	...
	const kotek::json::value& read_from)
{
	...
	#ifdef KOTEK_DEBUG
	KOTEK_ASSERT(
		data.at(ZIRCON_DEF_GAME_ZIRCON_COMPONENT_UI_CAMERA_FIELD_M_COMPONENT_TYPE)
